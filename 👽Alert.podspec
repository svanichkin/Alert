...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Sergey Vanichkin" => "sergey@vanichkin.ru" }
  # Or just: spec.author    = "Sergey Vanichkin"
  # spec.authors            = { "Sergey Vanichkin" => "sergey@vanichkin.ru" }
  # spec.social_media_url   = "https://twitter.com/SergeyVanichkin"
